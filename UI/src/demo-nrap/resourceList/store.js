...
var store = Reflux.createStore({
    ...
    onSearch: function(param) {
        ...
        //查询结束回调函数
        httpUtil.doGet(
            "http://192.168.120.156:8081/resourceList?WithNoValid=0&ResourceFlg=1",
    ...
    onDelete: function (ids) {
        ...
        httpUtil.doPost(
            "http://192.168.120.156:8081/deleteResource",
            ids,
            function(result,resultStr){
                this.deleteOk = result;
                if(result){
                    store.onSearch({ 
                        page: 0, //TODO 获取当前页码
                        querystring: "", //TODO 获取当前检索条件
    ...
    filterData: function(params){//TODO 抽取为共通
        ...
        //递归调用
        var forImmediate = function (i,end){
            if(i>end){
                console.log('==================调用递归完成 !');
            }else{
